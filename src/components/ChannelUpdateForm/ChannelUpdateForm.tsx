...
export function ChannelUpdateForm(props: ChannelUpdateFormProps) {
  ...
  return (
    <div className="ChannelUpdateForm">
      ...
      >
        {(formik) => (
          <Form className="form channel-update-form">
            <h2>
              Edition du channel{" "}
              <DisabledByDefaultRoundedIcon
                color="warning"
                onClick={props.closeChannelUpdate}
              />
            </h2>
            <div className="field-box">
              <div className="channel-update-form-title form__fields">
                <label className="form__labels" htmlFor="newchannel-title">
                  Titre :
                </label>
                <Field type="text" name="title" id="newchannel-title" />
              </div>
